...
ssize_t set_attr_snddaudio0(struct class *class, struct class_attribute *attr,
...
ssize_t get_attr_snddaudio0(struct class *class, struct class_attribute *attr, char *buf)
{
	ssize_t outsize  ;
...
//	__ATTR(dump, 0644, dump_show, dump_store),
	...
	__ATTR(daudio_pcm_select,	0644, get_attr_snddaudio0, set_attr_snddaudio0),
	__ATTR(daudio_master,		0644, get_attr_snddaudio0, set_attr_snddaudio0),
	__ATTR(audio_format,		0644, get_attr_snddaudio0, set_attr_snddaudio0),
	__ATTR(signal_inversion,	0644, get_attr_snddaudio0, set_attr_snddaudio0),
	__ATTR_NULL,
};

static struct class snddaudio0_class = {
    .name = "sunxi-snddaudio0",
    .owner = THIS_MODULE,
...
// ## hyphop ## add
    ...
    status = class_register(&snddaudio0_class);
    if (status < 0)
        pr_err("%s: status %d\n", __func__, status);
    else
        pr_info("%s success\n", __func__);
