...
ssize_t set_attr_daudio0(struct class *class, struct class_attribute *attr,
...
ssize_t get_attr_daudio0(struct class *class, struct class_attribute *attr, char *buf)
{
	ssize_t outsize  ;
...
static struct class_attribute daudio0_class_attrs[] = {

	__ATTR(mclk_fs,				0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(sample_resolution,	0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(pcm_lrck_period,		0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(pcm_lrckr_period,	0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(msb_lsb_first,		0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(sign_extend,			0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(slot_index,			0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(frame_width,			0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(tx_data_mode,		0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(rx_data_mode,		0644,	get_attr_daudio0, set_attr_daudio0),
	__ATTR(slot_width_select,	0644,	get_attr_daudio0, set_attr_daudio0),

	__ATTR_NULL,
};

static struct class daudio0_class = {
    .name = "sunxi-daudio0",
    .owner = THIS_MODULE,
    .class_attrs = daudio0_class_attrs,
};
...
// ## hyphop ## add
    ...
    status = class_register(&daudio0_class);
    if (status < 0)
        pr_err("%s: status %d\n", __func__, status);
    else
        pr_info("%s success\n", __func__);
